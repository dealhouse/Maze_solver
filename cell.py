...
class Cell:
    ...
    def draw(self):
        ...
        self._window.draw_line(Line(Point(self.x1, self.y1), Point(self.x1, self.y2)), color)

        color = "black" if self.has_right_wall else "white"
        self._window.draw_line(Line(Point(self.x2, self.y1), Point(self.x2, self.y2)), color)

        color = "black" if self.has_top_wall else "white"
        self._window.draw_line(Line(Point(self.x1, self.y1), Point(self.x2, self.y1)), color)
